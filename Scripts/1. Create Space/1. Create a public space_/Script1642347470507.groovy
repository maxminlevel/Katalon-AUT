...
WebUI.click(findTestObject('Object Repository/Khoa/Page_Element/div_PublicOpen space for anyone, best for c_08629a'))

WebUI.setText(findTestObject('Object Repository/Khoa/Page_Element/input_Upload_spaceName'), 'Public Space 0004')

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element/div_Create'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element  Public Space 0004/div_Invite_mx_AccessibleButton mx_SpaceRoom_87964d'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element  Public Space 0004/div_Leave Space'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element  Public Space 0004/button_Leave space'))
