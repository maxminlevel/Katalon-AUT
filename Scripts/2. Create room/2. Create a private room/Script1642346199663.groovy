...
WebUI.setText(findTestObject('Object Repository/Khoa/Page_Element/input_Create a private room_mx_Field_5'), 'Private Room 0001')

WebUI.setText(findTestObject('Object Repository/Khoa/Page_Element/input_Name_mx_Field_6'), 'Private Room 0001')

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element/button_Create Room'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element/div_Private Room 0001_mx_AccessibleButton m_c7edd6'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element/div_Room settings'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element/div_Leave room'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element/button_Leave'))
