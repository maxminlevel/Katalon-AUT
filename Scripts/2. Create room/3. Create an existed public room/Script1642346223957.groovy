...
WebUI.click(findTestObject('Object Repository/Khoa/Page_Element/div_Rooms_mx_AccessibleButton mx_RoomSublis_27fc2e'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element/span_Create new room'))

WebUI.setText(findTestObject('Object Repository/Khoa/Page_Element/input_Create a private room_mx_Field_5'), 'Existed Public Room 0001')

WebUI.setText(findTestObject('Object Repository/Khoa/Page_Element/input_Name_mx_Field_6'), 'Existed Public Room 0001')

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element/div_Private room (invite only)'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element/div_Public room'))

WebUI.setText(findTestObject('Object Repository/Khoa/Page_Element/input__mx_Field_7'), 'existed-public-room-0001')

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element/button_Create Room'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element/button_Cancel'))
