...
WebUI.click(findTestObject('Object Repository/Khoa/Page_Element/span_Private room (invite only)_mx_Dropdown_arrow'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element/div_Public room'))

WebUI.setText(findTestObject('Object Repository/Khoa/Page_Element/input_Create a private room_mx_Field_5'), 'Public Room 0004')

WebUI.setText(findTestObject('Object Repository/Khoa/Page_Element/input__mx_Field_7'), 'public-room-0004')
