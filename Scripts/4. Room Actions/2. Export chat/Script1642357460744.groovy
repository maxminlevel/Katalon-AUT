...
WebUI.click(findTestObject('Object Repository/Khoa/Page_Element  PublicRoom0001/div_Export chat'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element  PublicRoom0001/div_Plain Text'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element  PublicRoom0001/button_Export'))
