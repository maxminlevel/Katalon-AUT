...
WebUI.click(findTestObject('Object Repository/Khoa/Page_Element/div_Ctrl K_mx_AccessibleButton mx_LeftPanel_88084c'))

WebUI.setText(findTestObject('Object Repository/Khoa/Page_Element/input_Create a new room_dirsearch'), 'publicroom0001')

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element/div_View'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element  PublicRoom0001/div_PublicRoom0001_mx_AccessibleButton mx_R_7d7dc9'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element  PublicRoom0001/div_Room settings'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element  PublicRoom0001/span_Notifications'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element  PublicRoom0001/label_OffYou wont get any notifications'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element  PublicRoom0001/div_Room Settings - PublicRoom0001_mx_Acces_ebd30e'))
