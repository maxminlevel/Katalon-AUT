...
WebUI.click(findTestObject('Object Repository/Khoa/Page_Element  PublicRoom0001/div_Share room'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element  PublicRoom0001/img'))
