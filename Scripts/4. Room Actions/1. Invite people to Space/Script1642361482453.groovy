...
WebUI.click(findTestObject('Object Repository/Khoa/Page_Element  PublicRoom0001/div_Invite to this room'))

WebUI.click(findTestObject('Khoa/Page_Element  PublicRoom0001/a_share this room'))
