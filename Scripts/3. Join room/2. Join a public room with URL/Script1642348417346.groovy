...
WebUI.navigateToUrl('http://localhost:8080/#/room/#public-room-01:matrix.org')

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element  public-room-01/div_Join the discussion'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element  public-room-01/div_public-room-01_mx_AccessibleButton mx_R_4ce54f'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element  public-room-01/div_Room settings'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element  public-room-01/div_Leave room'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element  public-room-01/button_Leave'))
