...
WebUI.click(findTestObject('Object Repository/Khoa/Page_Element/span_Explore public rooms'))

WebUI.setText(findTestObject('Object Repository/Khoa/Page_Element/input_Create a new room_dirsearch'), 'public-Room')

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element/div_Join'))

WebUI.click(findTestObject('Object Repository/Khoa/Page_Element/div_public-room-01_mx_AccessibleButton mx_R_4ce54f'))
