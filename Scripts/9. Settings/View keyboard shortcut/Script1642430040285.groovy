...
WebUI.click(findTestObject('Object Repository/Thang/Page_Element/span_All settings'))

WebUI.click(findTestObject('Object Repository/Thang/Page_Element/div_Help  About'))

WebUI.click(findTestObject('Object Repository/Thang/Page_Element/div_Keyboard Shortcuts'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Thang/Page_Element/h2_Keyboard Shortcuts'))
