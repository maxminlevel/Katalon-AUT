...
WebUI.setText(findTestObject('Object Repository/Thang/Page_Element/input_Sign in with_username'), 'catalontest1@gmail.com')
...
WebUI.click(findTestObject('Object Repository/Thang/Page_Element/div_Feedback'))

WebUI.setText(findTestObject('Object Repository/Thang/Page_Element/textarea_a'), 'a')

WebUI.setText(findTestObject('Object Repository/Thang/Page_Element/textarea_ap'), 'ap')

WebUI.setText(findTestObject('Object Repository/Thang/Page_Element/textarea_app'), 'app')

WebUI.setText(findTestObject('Object Repository/Thang/Page_Element/textarea_app_1'), 'app ')

WebUI.setText(findTestObject('Object Repository/Thang/Page_Element/textarea_app o'), 'app o')

WebUI.setText(findTestObject('Object Repository/Thang/Page_Element/textarea_app ok'), 'app ok')

WebUI.click(findTestObject('Object Repository/Thang/Page_Element/button_Send feedback'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Thang/Page_Element/h2_Feedback sent'))
