...
WebUI.click(findTestObject('Object Repository/Thang/Page_Element/div_English (US)'))

WebUI.click(findTestObject('Object Repository/Thang/Page_Element/div_Ting Vit'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Thang/Page_Element/h1_Cho mng bn n vi Element'))
